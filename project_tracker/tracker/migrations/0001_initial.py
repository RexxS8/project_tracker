# Generated by Django 5.2 on 2025-06-11 08:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('man_power', models.CharField(blank=True, help_text='List nama orang yang terlibat (pisahkan dengan koma)', max_length=255, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='CustomUser',
        ...
        migrations.AddField(
            model_name='meetingweek',
            name='project',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='meeting_weeks', to='tracker.project'),
        ),
        migrations.CreateModel(
            name='WeeklyProgress',
            fields=[
